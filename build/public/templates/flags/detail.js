...
(function (factory) {
  ...
  function compiled(helpers, context, guard, iter, helper) {
    ...
    return (guard((context != null && context['breadcrumbs'] != null) ? context['breadcrumbs']['length'] : null) ?
      ...
      "\n\t\t\t<small><span class=\"text-muted timeago\" title=\"" + 
      ...
      (guard((context != null && context['type_bool'] != null) ? context['type_bool']['post'] : null) ?
        "\n\t\t<div class=\"d-flex\">\n\t\t\t<div class=\"flex-shrink-0\">\n\t\t\t\t<a href=\"" + 
          ...
          "\">" + 
          __escape(helper(context, helpers, 'buildAvatar', [guard((context != null && context['target'] != null) ? context['target']['user'] : null), "64px", guard((context != null) ? context['true'] : null), "media-object"])) + 
      ...
      (guard((context != null && context['type_bool'] != null) ? context['type_bool']['user'] : null) ?
        "\n\t\t<div class=\"d-flex\">\n\t\t\t<div class=\"flex-shrink-0\">\n\t\t\t\t<a href=\"" + 
          ...
          "\">" + 
          __escape(helper(context, helpers, 'buildAvatar', [guard((context != null) ? context['target'] : null), "64px", guard((context != null) ? context['true'] : null), "media-object"])) + 
          "</a>\n\t\t\t</div>\n\t\t\t<div class=\"flex-grow-1 ms-3\">\n\t\t\t\t<h4 class=\"media-heading\"><a href=\"" + 
          __escape(guard((context != null && context['config'] != null) ? context['config']['relative_path'] : null)) + 
          "/user/" + 
          __escape(guard((context != null && context['target'] != null) ? context['target']['userslug'] : null)) + 
          ...
          (guard((context != null && context['privileges'] != null) ? context['privileges']['ban'] : null) ?
            "\n\t\t\t\t\t\t\t<li class=\"" + 
              (guard((context != null && context['target'] != null && context['target']['user'] != null) ? context['target']['user']['banned'] : null) ?
                "hidden" :
                "") + 
              "\"><a class=\"dropdown-item\" href=\"#\" data-action=\"ban\">[[user:ban-account]]</a></li>\n\t\t\t\t\t\t\t<li class=\"" + 
              (guard((context != null && context['target'] != null && context['target']['user'] != null) ? context['target']['user']['banned'] : null) ?
                "" :
                "hidden") + 
              "\"><a class=\"dropdown-item\" href=\"#\" data-action=\"unban\">[[user:unban-account]]</a></li>\n\t\t\t\t\t\t\t" :
            "") + 
          "\n\t\t\t\t\t\t\t" + 
          (guard((context != null && context['privileges'] != null) ? context['privileges']['mute'] : null) ?
            "\n\t\t\t\t\t\t\t<li class=\"" + 
              (guard((context != null && context['target'] != null && context['target']['user'] != null) ? context['target']['user']['muted'] : null) ?
                "hidden" :
                "") + 
              "\"><a class=\"dropdown-item\" href=\"#\" data-action=\"mute\">[[user:mute-account]]</a></li>\n\t\t\t\t\t\t\t<li class=\"" + 
              (guard((context != null && context['target'] != null && context['target']['user'] != null) ? context['target']['user']['muted'] : null) ?
                "" :
                "hidden") + 
              "\"><a class=\"dropdown-item\" href=\"#\" data-action=\"unmute\">[[user:unmute-account]]</a></li>\n\t\t\t\t\t\t\t" :
            "") + 
          "\n\t\t\t\t\t\t\t" + 
  ...
  compiled.blocks = {
    ...
    'reports': function reports(helpers, context, guard, iter, helper) {
      ...
      return iter(guard((context != null) ? context['reports'] : null), function each(key0, index, length, value) {
        ...
        return "\n\t\t\t\t\t\t\t<li class=\"list-group-item\">\n\t\t\t\t\t\t\t\t<a href=\"" + 
          ...
          "\">" + 
          __escape(helper(context, helpers, 'buildAvatar', [guard((context != null && context['reports'] != null && context['reports'][key0] != null) ? context['reports'][key0]['reporter'] : null), "24px", guard((context != null) ? context['true'] : null)])) + 
    ...
    'notes': function notes(helpers, context, guard, iter, helper) {
      ...
      return iter(guard((context != null) ? context['notes'] : null), function each(key0, index, length, value) {
        var key = key0;
        return "\n\t\t\t\t\t<div class=\"d-flex mb-3\" component=\"flag/note\" data-datetime=\"" + 
          ...
          "\">" + 
          __escape(helper(context, helpers, 'buildAvatar', [guard((context != null && context['notes'] != null && context['notes'][key0] != null) ? context['notes'][key0]['user'] : null), "32px", guard((context != null) ? context['true'] : null), "media-object"])) + 
    ...
    'history': function history(helpers, context, guard, iter, helper) {
      ...
      return iter(guard((context != null) ? context['history'] : null), function each(key0, index, length, value) {
        ...
        return "\n\t\t\t\t\t<div class=\"d-flex\">\n\t\t\t\t\t\t<div class=\"flex-shrink-0\">\n\t\t\t\t\t\t\t<a href=\"" + 
          ...
          "\">" + 
          __escape(helper(context, helpers, 'buildAvatar', [guard((context != null && context['history'] != null && context['history'][key0] != null) ? context['history'][key0]['user'] : null), "32px", guard((context != null) ? context['true'] : null), "media-object"])) + 
          ...
          iter(guard((context != null && context['history'] != null && context['history'][key0] != null) ? context['history'][key0]['fields'] : null), function each(key1, index, length, value) {
            var key = key1;
            return "\n\t\t\t\t\t\t\t\t<li>\n\t\t\t\t\t\t\t\t\t<span class=\"badge bg-primary\">[[flags:" + 
              __escape(key) + 
              "]]</span>" + 
              (guard(value) ?
                " &rarr; <span class=\"badge bg-light text-dark\">" + 
