...
(function (factory) {
  ...
  function compiled(helpers, context, guard, iter, helper) {
    ...
    return "<div class=\"chats-full d-flex gap-1 h-100 px-3\">\n\t<div component=\"chat/nav-wrapper\" class=\"flex-shrink-0 d-flex flex-column h-100 gap-1\" data-loaded=\"" + 
      ...
      (guard((context != null && context['publicRooms'] != null) ? context['publicRooms']['length'] : null) ?
        "\n\t\t\t<div class=\"d-flex gap-1 align-items-center\">\n\t\t\t\t<button class=\"btn btn-sm btn-light p-1\" data-bs-toggle=\"collapse\" data-bs-target=\"#private-rooms\"\n\t\t\t\tonclick=\"$(this).find('i').toggleClass('fa-chevron-right').toggleClass('fa-chevron-down');\"><i class=\"fa fa-fw fa-chevron-down\"></i></button>\n\t\t\t\t<label class=\"text-sm text-muted\">[[modules:chat.private-rooms, " + 
          __escape(guard((context != null) ? context['privateRoomCount'] : null)) + 
          "]]</label>\n\t\t\t</div>\n\t\t\t" :
        "") + 
      "\n\n\t\t\t<ul id=\"private-rooms\" component=\"chat/recent\" class=\"chats-list overflow-auto mb-0 list-unstyled collapse show\" data-nextstart=\"" + 
  ...
  compiled.blocks = {
    'publicRooms': function publicRooms(helpers, context, guard, iter, helper) {
      ...
      return iter(guard((context != null) ? context['publicRooms'] : null), function each(key0, index, length, value) {
        var key = key0;
        return "\n\t\t\t\t\t<div component=\"chat/public/room\" class=\"btn btn-sm btn-light d-flex justify-content-between hover-parent " + 
          ...
          "\" class=\"badge border text-primary bg-light " + 
            ...
            return "\n\t" + 
              (index === 0 ?
                "\n\t<div class=\"main-avatar me-2\">\n\t\t<a href=\"" + 
                  ...
                  "\">" + 
                  __escape(helper(context, helpers, 'buildAvatar', [guard((context != null && context['rooms'] != null && context['rooms'][key0] != null && context['rooms'][key0]['users'] != null) ? context['rooms'][key0]['users'][key1] : null), "28px", guard((context != null) ? context['true'] : null)])) + 
                  "</a>\n\t</div>\n\t" :
                "") + 
              "\n\t";
          }, function alt() {
    ...
    'users': function users(helpers, context, guard, iter, helper) {
      ...
      return iter(guard((context != null) ? context['users'] : null), function each(key0, index, length, value) {
        ...
        return "\n\t<a data-index=\"" + 
          ...
          "\" class=\"btn btn-sm btn-light d-flex justify-content-start align-items-center gap-2\" href=\"" + 
          __escape(guard((context != null && context['config'] != null) ? context['config']['relative_path'] : null)) + 
          "/uid/" + 
          __escape(guard((context != null && context['users'] != null && context['users'][key0] != null) ? context['users'][key0]['uid'] : null)) + 
          "\">\n\t\t<div>" + 
